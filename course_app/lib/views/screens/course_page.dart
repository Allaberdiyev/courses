...
class _CourseListScreenState extends State<CourseListScreen> {
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Sotib olmoqchimisiz?'),
          actions: <Widget>[
            TextButton(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(255, 145, 147, 148),
      appBar: AppBar(
        backgroundColor: Color.fromARGB(255, 145, 147, 148),
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        ...
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return const Center(child: Text('Kurs topilmadi.'));
          }
              ...
              Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(
                      Icons.shopping_cart,
                      color: Color.fromARGB(255, 0, 87, 65),
                    ),
                    onPressed: () => _buyCourse(course),
                  ),
                ],
